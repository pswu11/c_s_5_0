...
def index():
    ...
    return render_template("index.html", userinfo=userinfo, balance=balance_with_current_values, total_stock_value=total_stock_value, transaction=latest_transaction)
